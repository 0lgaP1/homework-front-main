...
export const HW2 = () => {
  ...
  let [currentUsers, setCurrentUsers] = useState<UserType[]>(users.myFriends); // <UsersObjectType("")

  const filterUsers = () => {
    const filteredUsers = currentUsers.filter((user)=>user.address.city === "Los Angeles");
